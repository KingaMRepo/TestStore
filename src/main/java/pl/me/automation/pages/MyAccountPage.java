...
public class MyAccountPage extends Menu {
    ...
    public LoggedInUserPage fillInMyAccountRegistration(String name,String email, String password) {
            userNameInput.clear();
     ...
     public MyAccountPage fillInMyAccountRegistrationFail(String name,String email, String password){
         userNameInput.clear();
         userNameInput.sendKeys(name);
         userEmailInput.clear();
         userEmailInput.sendKeys(email);
    ...
    public MyAccountPage fillLoginFormWithRememberMeCheckbox(String nameOrEmail, String loginPassword) {
        wait.until(ExpectedConditions.elementToBeClickable(userNameOrEmailInput));userNameOrEmailInput.clear();
        userNameOrEmailInput.sendKeys(nameOrEmail);
        loginPasswordInput.clear();
        loginPasswordInput.sendKeys(loginPassword);
